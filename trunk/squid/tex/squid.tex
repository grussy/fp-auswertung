...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=0.9\linewidth]{pictures/sim1.eps}
\caption{Fit an SIM Achse 1.}
\end{minipage}
\begin{minipage}{0.5\linewidth}
\centering 
\includegraphics[width=0.9\linewidth]{pictures/sim1vd.eps}
\caption{Polardarstellung.}
\label{sim1}
\end{minipage}
\end{figure}
...
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=0.9\linewidth]{pictures/sim2.eps}
\caption{Fit an SIM Achse 2.}
\end{minipage}
\begin{minipage}{0.5\linewidth}
\centering 
\includegraphics[width=0.9\linewidth]{pictures/sim2vd.eps}
\caption{Polardarstellung.}
\label{sim2}
\end{minipage}
\end{figure}
