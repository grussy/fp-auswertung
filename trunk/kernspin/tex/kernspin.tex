...
Dieser relativ große Fehler kommt eindeutig aus der Messung der Hallsonde. Wir haben daher mal das gewichtete Mittel aller Magnetfeldmessungen mit der Wasserstoffprobe gebiltet und erhielten:
\begin{align}
 B_{wasserstoff}= (0.427407 \pm 5.4e-12) T
\end{align}

Mit diesem Wert ergibt sich ein g-Faktor von:
\begin{align}
