...
\begin{center}
Ergebnisse der Absorbtionsverhältnisse \\
% use packages: array
\begin{tabular}{|l|ll|}
\hline
Energie [keV] & Messergebniss [\%] & Fehler [\%] \\
\hline
59.5 & 22.07 & 0.06 \\
122.04 & 21.83 & 0.01 \\
136.47 & 21.82 & 0.03 \\
...
Mit diesen Formeln erhielten wir aus unseren Messdaten:
\begin{center}
Ergebnisse der relativen Energieauflösungen(RER) \\
% use packages: array
\begin{tabular}{|l|ll|ll|}
\hline
Energie [keV] & RER von Si & Fehler & RER von CdTe & Fehler \\
\hline
59.5 & 0.093 & 0.0056 & 0.103 & 0.0039 \\
122.04 & 0.048 & 0.0013 & 0.048 & 0.0012 \\
136.47 & 0.046 & 0.0090 & 0.044 & 0.0022 \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
 \item \textbf{Vermessung der Bandlücke}
\begin{align*}
...
\item \textbf{Haynes-Shockley Experiment}
...
\item \textbf{Halbleiterdetektor:} \\
Wir hatten grosse Schwierigkeiten die Auswertung dieses Teils richtig zu verstehen. Man hat kein Referenzspektrum, mit dem man den Verlauf des selbst gemessenen Vergleichen könnte. Wir haben also nach Rücksprache mit der Tutorin angenommen das die Peaks der bekannten Energien ungefähr in den gleichen Kanälen des MCA wie in der Staatsexamensarbeit gelandet sind. Mit dieser Annahme erhielten wir folgende Ergebnisse:
...
hierfür erhielten wir als Messergebnisse und Fehler:
\begin{center}
% use packages: array
\begin{tabular}{|l|ll|ll|}
\hline
...
\end{tabular}
\end{center}
da hier den Studenten keine Angaben über Litheraturwerte oder Messergebnisse zugänglich gemacht werden, kann auch kein Vergleich mit solchen Referenzwerten erfolgen.
\end{itemize}
\end{document}
