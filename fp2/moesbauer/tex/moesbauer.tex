...
im Rahmen seiner Dissertationsarbeit wollte Mößbauer die Wahrscheinlichkeit für die Emissionen und anschließende Absorption eines Gammaquant untersuchen.
...
und zwar über die bei hohen Temperaturen gemessenen. Dies zunächst verblüffende Ergebnis konnte von Mössbauer durch die höhere Trägheit der im Festkörper
gebundenen Atome erklären. Diese sorgt dafür das bei der Impulsbilanz der Stöße nicht mehr die Masse eines Atoms sondern die eines ganzen Mols Stoffmasse 
...
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../eichung/energie_eichung.py}
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../untergrund/untergrund.py}
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../messung/edelstahl.py}
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../messung/konst.py}
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../messung/fit_tools.py}
\lstinputlisting[language=python, extendedchars=false, inputencoding=utf8]{../messung/eisen.py}
