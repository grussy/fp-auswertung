...
Die Dicke des Aluminiumabsorbers haben wir jeweils mit der Mikrometerschraube gemessen und somit einen Fehler von 0,01 mm auf diese angenommen. Da die Mikrometerschraube leider wohl schon mal mit Gewalt in Berührung kam hat diese einen Offset den man n
Der Fehler sR der Z ̈hlrate R = N/t ergibt sich aus dem statistischen Fehler
                       a
       √
sN = N der Ereigniszahl und dem Fehler st = 1 ms der Messzeit t zu:
                                          st       sN
                                             2         2
                            sR = R ·           +         .
                                           t       N
Aus dem durchgef ̈hrten Fit ergab sich so f ̈r die Abschirmung der γ-Quanten
                    u                           u
h ̈herer Energie folgender Zusammenhang zwischen Abschirmungsdicke d in mm
 o
und Z ̈hlrate R:
       a
                f2 (d) = (69,11 ± 0,28) · exp (−0,0378 ± 0,0006) cps
Damit ergibt sich durch Extrapolation auf eine Abschirmungsdicke d = 0 als
Z ̈hlrate Rug f ̈r den Compton-Untergrund im 14,4 keV-Fenster:
  a            u
                              Rug = (69,11 ± 0,28) cps
Diese Untergrundrate wurde bei allen folgenden Messungen ber ̈cksichtigt und
                                                                    u
von den aufgenommenen Z ̈hlraten abgezogen. Der Fehler wurde dabei auch
                              a
durch gaußsche Fehlerfortpflanzung berechnet.
Es ist noch anzumerken, dass es sich hierbei um eine zweite Untergrund-Messung
handelt, die wir am Ende des Versuchs durchgef ̈hrt haben. Die erste Messung,
                                                    u
vom Anfang des Versuchs, wurde von uns nicht weiter ber ̈cksichtigt, da wir
                                                               u
f ̈r deren Aufnahme keine Messungen mit kleinen Abschirmdicken durchgef ̈hrt
 u                                                                          u
hatten. Trotzdem sei hier nochmal das Ergebnis der ersten Messung angegeben:
