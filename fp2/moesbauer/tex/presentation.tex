...
\column{.55\textwidth}
\begin{itemize}
 \item unterschiedliche Ladungsdichteverteilungen von angeregtem und Kern im Grundzustand
 \item Elektronenhülle erzeugt unterschiedliche Coulombenergien
\end{itemize}
\column{.45\textwidth}
\includegraphics[width=0.9\linewidth]{pictures/isomerie.eps}
\end{columns}
\vfill
$\Rightarrow$ Bestimmung des Absorberstoffes durch Isomerieverschiebung möglich
}


\subsection{Aufbau}

\frame{\frametitle{Versuchaufbau}
\centering 
\begin{figure}[H]  
\includegraphics[width=0.75\linewidth]{pictures/debye.eps}
\end{figure}
