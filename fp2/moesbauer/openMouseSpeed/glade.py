...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.grid_1 = wx.grid.Grid(self.notebook_2_pane_1, -1, size=(1, 1))
        ...
        self.grid_2 = wx.grid.Grid(self.tabsMain_pane_3, -1, size=(1, 1))
    ...
    def __set_properties(self):
        ...
        self.grid_1.SetColLabelValue(0, "Time")
        self.grid_1.SetColLabelValue(1, "Velocity")
        self.grid_1.SetColLabelValue(2, "Factor")
        self.grid_1.SetColLabelValue(3, "[mm/s]")
        ...
        self.grid_2.CreateGrid(10, 4)
        self.grid_2.SetColLabelValue(0, "Time")
        self.grid_2.SetColLabelValue(1, "[mm]")
        self.grid_2.SetColLabelValue(2, "value")
        self.grid_2.SetColLabelValue(3, "factor")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_10.Add(self.grid_2, 1, wx.EXPAND, 0)
    ...
    def InitVariables(self):
        self.grid_1.SetColFormatFloat(1, 8, 3)
        self.grid_1.SetColFormatFloat(2, 8, 3)
        self.grid_1.SetColFormatFloat(3, 8, 3)
        self.grid_1.SetColFormatFloat(4, 8, 3)
        self.grid_2.SetColFormatFloat(2, 8, 3)
        self.grid_2.SetColFormatFloat(3, 8, 3)
        self.grid_2.SetColFormatFloat(4, 8, 3)
                    ...
                    if (byte == '\n'):
                        ...
                        try :
                            ...
                            for char in self.savedBuffer:
                                ...
                                helpStr += char
                            if (interrupts == 1):
                                print "%i interrupts %i timer %i overflows"%(interrupts, timer, overflows)
                                ...
                                self.tableCount += 1
                                if (self.grid_1.GetNumberRows() - self.tableCount <= 5):
                                    self.grid_1.AppendRows(10, 0)
                                self.grid_1.SetCellValue(self.tableCount, 0, str(self.elapsedTime))
                                self.grid_1.SetCellValue(self.tableCount, 1, str(self.vel[-1]))
                                self.grid_1.SetCellValue(self.tableCount, 2, str(0.0))
                                self.grid_1.SetCellValue(self.tableCount, 3, str(0.0))
