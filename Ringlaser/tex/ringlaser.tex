...
\begin{figure}[H]  
\centering
\includegraphics[width=0.9\linewidth]{abb1.eps}
...
\begin{figure}[H]  
\centering
\includegraphics[width=0.9\linewidth]{abb3.eps}
...
\begin{figure}[H]  
\centering
\includegraphics[width=0.7\linewidth]{abb4.eps}
\caption{Versuchsanordnung Ringlaser}
\label{versuchsaufbau}
\end{figure}

\section{Durchführung}
Nach der Justierung der Blende und des Auskopplungsspiegels konnte man auf dem Oszilloskop
\section{Auswertung}
