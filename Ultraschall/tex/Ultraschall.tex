...
\begin{align}
 \frac{I_m}{I_{m'}} = \frac{J^2_m(\Delta n~D \cdot 2~\pi~/~\lambda)}{J^2_{m'}(\Delta n \cdot 2~\pi~/~\lambda)}
\end{align}
...
Aus diesem Fit erhält man also direkt die Umrechnung $sin(\vartheta)=at+b$ mit $a=(62,22\pm 0,03)s{-1}$ und $b=(2,92\pm 6,7)\cdot 10^{-6}$. Wir können also nun Anhand der Zeitskala auf den Sinus des Beugungswinkels der Gitter mit unbekanntem K rückschliessen. Der Fehler hierfür ergibt sich zu:
\begin{align}
...
\begin{align}
 \Lambda = \frac{\lambda}{a} = (5.678 \pm 0,052) \cdot 10^{-4} m
\end{align}
...
\large{\textbf{Fazit}}
Leider konnten wir die Raman Nath Theorie nur teilweise verfifizieren, und die Auflösungsvermögen liessen sich nur bis auf einen zu grossen Fehler bestimmen.
Letzteres lag an der schlechten Messmöglichkeit des Strahldurchmessers. Alle anderen Versuchsteile erzielten befriedigende Ergebnisse.
...
\begin{itemize}
\item Als Gitterkonstante des Sinusgitters erhielten wir 
\begin{align}
 \notag
 K=(9,95\pm0,24)\cdot 10^{-7}m .
\end{align}

\item Als Gitterkonstanten der fünf Amplitudengitter erhielten wir
\begin{align}
 \notag
K_1 &= ( 137,17 \pm 0,08)\mu m \\
 \notag
...
\item Für Gitter 1 erhielten wir über die Aperturfunktion den Abstand von Spaltbreite zu Spaltabsand zu
\begin{align}
 \notag
v=0.19837 \pm 0,00019
\end{align}

\item Als maximal Auflösevermögen der Gitter erhielten wir
\begin{align}
 \notag
a_1 &=  109 \pm  18\\
 \notag
...
\item Durch die Messergebnisse am Phasengitter lies sich die Raman-Nath-Theorie nur teilweise verifizieren, 
für die erste Beugungsordnung stimmt der Kurvenverlauf der Messergebnisse recht gut mit dem erwarteten überein.
Für die zweite stimmt der Verlauf qualitativ auch noch ungefär, für alle anderen erkannten wir leider keine Übereinstimmung 
unserer Messungen mit der jeweiligen quatrierten Besselfunktion. Dies deutet auf auf einen systematischen Fehler 
unserer Messung hin, zB könnte aufgrund der geringen Füllhöhe des Isooktantanks die Korellation zwischen angelegter Spannung und dadurch entstehender 
Amplitude der Ultraschallwelle verändert worden sein.

\item Als Schallwellenlänge erhielten wir
\begin{align}
\notag
 \Lambda = (5.678 \pm 0,052) \cdot 10^{-4} m
\end{align}
