...
Die Mathematik zur Auswertung ist im Kapitel der theoretischen Grundlagen besprochen worden.
...
\begin{itemize}
 \item Beweglichkeit der Elektronen ~~~~~~$\mu = $ 
 \item Lebensdauer der Elektronen ~~~~~~~~$\tau = $
 \item Diffusionskonstante der Elektronen $D = $
\end{itemize}
